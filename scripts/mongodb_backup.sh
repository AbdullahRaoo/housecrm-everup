...
DATE=$(date +"%Y-%m-%d-%H-%M")
BACKUP_DIR="/home/tabish/Projects/CRM_Realstate/backups/mongodb"

# Create backup directory if it doesn't exist
mkdir -p $BACKUP_DIR

# MongoDB Atlas connection string (using the one from your .env file)
CONNECTION_STRING="mongodb+srv://Tabish:chaku5858@cluster0.bdnet.mongodb.net/crm?retryWrites=true&w=majority"
